        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Sets you're actively collecting</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-3xl font-bold">{collectingSets[0].count}</div>
            </CardContent>
          </Card>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card>
            ...
            <CardContent className="space-y-4">
              <Link href="/collection/add">
                <Button className="w-full justify-start">Add Cards to Collection</Button>
              </Link>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your latest collection additions</CardDescription>
            </CardHeader>
            <CardContent>
              {recentCards.length === 0 ? (
                <p className="text-gray-500 text-center py-4">No cards added yet. Start building your collection!</p>
              ) : (
                    ...
                    <div key={card.id} className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                      <div>
                        ...
                        <div className="text-sm text-gray-500">
                          {card.set_code} #{card.card_number} • {card.language_name} • {card.variant_name}
                        </div>
                      </div>
                      <div className="text-sm text-gray-500">{card.condition_name}</div>
                    </div>
                  ))}
                </div>
              )}
