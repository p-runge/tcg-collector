...
import { usePokemonCards, usePokemonSets } from "@/hooks/usePokemonData";
import { cardLanguages, PokemonSet, RARITIES } from "@/lib/pokemon-api";
import {
  Edit3,
  Eye,
  Grid,
...
export default function PokemonCollectionManager() {
  ...
  const {
    ...
    error: cardsError,
  } = usePokemonCards(selectedSet?.id ?? null);
                  ...
                  <CardContent className="text-center py-12">
                    <div className="space-y-4">
                      ...
                      <p className="text-muted-foreground">
                        Loading cards for {selectedSet.name}...
                      </p>
                    </div>
                  </CardContent>
                </Card>
